    ...
    return(
        <div className="container--main-header">
            ...
            <div className="header--icons">
                <ul>
                    <li onClick={handleGithub}> <AiFillGithub size={35} color="#d2dae2"/> </li>
                    <li onClick={handleLinkedin}> <AiFillLinkedin size={35} color="#d2dae2"/> </li>
                    <li onClick={handleEmail}> <AiOutlineMail size={35} color="#d2dae2"/> </li>
                </ul>
            </div>
